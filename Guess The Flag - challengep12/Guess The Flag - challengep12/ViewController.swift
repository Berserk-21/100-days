...
class ViewController: UIViewController {
    ...
    private let highestScoreKey: String = "highestScoreKey"
    ...
    private func getHighestScore() {
        ...
        if let savedHighestScore = userDefault.object(forKey: highestScoreKey) as? Int {
    ...
    private func saveHighestScore() {
        ...
        if score > highestScore {
            let userDefault = UserDefaults.standard
            userDefault.set(score, forKey: highestScoreKey)
        }
    }
    ...
    @IBAction func flagWasTapped(_ sender: Any) {
        ...
        if selectedButton.tag == correctAnswer {
            ...
            if score > highestScore {
                title = "New record !"
                message = "Your highest score is \(score)"
            } else {
                title = "Correct !"
